...
function inherits(e,n,t){e.super_=n,e.prototype=Object.create(n.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&angular.extend(e.prototype,t)}function nextId(){return id++,id}function digest(e,n,t){e&&(angular.isUndefined(n)&&(n=function(){}),e.$$phase||e.$root&&e.$root.$$phase?e.$applyAsync(n.bind(t)):e.$apply(n.bind(t)))}var mobie={};mobie.isScope=function(e){return e&&e.$apply&&e.$applyAsync},mobie.defaults=function(e,n){var t=angular.copy(n);return angular.isObject(e)&&angular.isObject(t)?angular.extend(e,t):e};var id=0;mobie.digest=digest,angular.module("mobie.core.helpers",["mobie.core.eventemitter"]);
