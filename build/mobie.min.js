...
function $MbActionSheetProvider(){function n(n,e,o,i,c,u,r,a){function s(n){27==n.which&&V.close()}function f(){return m().then(function(){return S.hide()})}function l(){return m().then(function(){return S.hide()})}function h(n){o.safeDigest(V,n)}function m(){return u(function(n){h(function(t){n(t)})})}function p(){return m().then(function(){A.off("click",f),a.off("keyup",s)})}function d(){return m().then(function(){A.on("click",f),a.on("keyup",s)})}function b(n){return m().then(function(){return c[n?"addClass":"removeClass"](bodyEl,w.activeBodyClass)})}function $(n){return m().then(function(){return r(function(){return i[n?"show":"hide"]()},240)})}function g(){return T.getVisibleState()}function v(n){return m().then(function(){return T[n?"show":"hide"]()})}function k(n){return u.all([v(!1),$(n),b(!1)]).then(function(){return p(),B("visible")})}function x(){y({text:"",title:"",template:"",buttons:[]})}function y(n){h(function(t){angular.extend(t,n)})}function B(n){return n=angular.isString(n)?n:"notVisible",u(function(t){T.once(n,function(){t()})})}function C(n){return g()?k(!0).then(function(){return C(n)}):(x(),y(n),angular.forEach(V.buttons,function(n){if(angular.isFunction(n.onTap)||(n.onTap=l),angular.isArray(n.classes)){var t=n.classes;n.classes={},angular.forEach(t,function(t){n.classes[t]=!0})}}),u.all([v(!0),$(!0),b(!0)]).then(function(){return d(),B("notVisible")}))}var S={},w={scope:e.$new()};w=angular.extend({},t,w);var E=S.component=n(w),T=E.component,A=(T.getElement(),i.getElement()),V=w.scope;return S.show=C,S.hide=k,V.$$close=V.close=function(){return S.hide()},V.cancelTextButton=t.cancelTextButton,V.scope=V,S}var t=this.defaults={templateUrl:"mobie/components/action-sheet.html",activeBodyClass:"mb-action-sheet-visible",cancelTextButton:"Cancel"};this.$get=n,n.$inject=["$mbComponent","$rootScope","Helpers","$mbBackdrop","$animate","$q","$timeout","$document"]}angular.module("mobie.components.action-sheet",["mobie.components.backdrop","mobie.core.component","mobie.core.helpers"]).provider("$mbActionSheet",$MbActionSheetProvider);
...
function BarFixedTopDirective(n,e,o,i,r){function t(e,t){function c(){return o.cancel(l)}function u(n){return r.safeDigest(e,function(){c(),l=o(function(){return f[n?"show":"hide"]()},a)})}var l,a=60,f=new i(t),s=!0;n.on("scrollTop",function(){u(!0)}),n.on("scrollDown",function(){u(!1)}),n.on("scrollUp",function(){u(!0)}),u(s)}return{restrict:"A",compile:function(n){return n.addClass("mb-fixed-top"),t}}}BarFixedTopDirective.$inject=["$mbScroll","$animate","$timeout","MbComponent","Helpers"],angular.module("mobie.components.bar",["mobie.core.scroll"]).directive("mbBarFixedTop",BarFixedTopDirective);
