...
function BarFixedTopDirective(n,e,o,i,r){function t(e,t,c){function u(){return o.cancel(a)}function l(n){return r.safeDigest(e,function(){u(),a=o(function(){return s[n?"show":"hide"]()},f)})}var a,f=60,s=new i(t),m=!0;n.on("scrollTop",function(){l(!0)}),n.on("scrollDown",function(n){l(!1)}),n.on("scrollUp",function(n){l(!0)}),l(m)}return{restrict:"A",compile:function(n,e){return n.addClass("mb-fixed-top"),t}}}BarFixedTopDirective.$inject=["$mbScroll","$animate","$timeout","MbComponent","Helpers"],angular.module("mobie.components.bar",["mobie.core.scroll"]).directive("mbBarFixedTop",BarFixedTopDirective);
...
function $MbPopupProvider(){function n(n,e,o,r,u,i,c){function a(n){return l().then(function(){return n.target===x[0]?E.hide():void 0})}function s(){return l().then(function(){return E.hide()})}function f(n){e.safeDigest(B,n)}function l(){return i(function(n){f(function(t){n(t)})})}function p(){return l().then(function(){x.off("click",a)})}function m(){return l().then(function(){x.on("click",a)})}function h(n){return l().then(function(){return u[n?"addClass":"removeClass"](bodyEl,P.activeBodyClass)})}function d(n){return l().then(function(){return r[n?"show":"hide"]()})}function b(){return w.getVisibleState()}function g(n){return l().then(function(){return w[n?"show":"hide"]()})}function v(n){return i.all([g(!1),d(n),h(!1)]).then(function(){return p()})}function $(){y({text:"",title:"",template:"",buttons:[]})}function y(n){f(function(t){angular.extend(t,n)})}function C(n){return b()?v(!0).then(function(){return C(n)}):($(),y(n),angular.forEach(B.buttons,function(n,t){if(angular.isFunction(n.onTap)||(n.onTap=s),angular.isArray(n.classes)){var e=n.classes;n.classes={},angular.forEach(e,function(t){n.classes[t]=!0})}}),i.all([g(!0),d(!0),h(!0)]).then(function(){return m()}))}var E={},P={scope:o.$new()};P=angular.extend({},t,P);var k=E.component=n(P),w=k.component,x=w.getElement(),B=P.scope;return E.show=C,E.hide=v,E}this.$get=n;var t=this.defaults={templateUrl:"mobie/components/popup.html",activeBodyClass:"mb-popup-visible"};n.$inject=["$mbComponent","Helpers","$rootScope","$mbBackdrop","$animate","$q","$timeout"]}var bodyEl=angular.element(document.body);angular.module("mobie.components.popup",["mobie.core.helpers","mobie.core.component","mobie.components.backdrop"]).provider("$mbPopup",$MbPopupProvider);
function MbSidenavController(e,n,i,o,t,r,c,a,l,s,d){function m(n){return r.safeDigest(e,n)}function u(e){m(function(){l[e?"show":"hide"](),angular.isString(g)&&t[e?"addClass":"removeClass"](b,g)})}function v(e){m(function(){C.hide()})}var b=angular.element(d.document.body),f=l.getElement(),p=s.getOptions(),g=p.activeBodyClass,C=this.component=new c(n,{id:i.componentId});a.register(this.component),C.on("visibleChangeStart",function(){u(!0)}),C.on("visible",function(){f.on("click",v)}),C.on("notVisible",function(){f.off("click",v),u(!1)})}function CloseDirective(){return{require:"?^mbSidenav",link:function(e,n,i,o){angular.isUndefined(o)||n.on("click",function(){e.$apply(function(){o.component.hide()})})}}}function $MbSidenavProvider(){function e(e){return angular.extend(function(n){return e.get(n)},{getOptions:function(){return n}})}var n=this.defaults={activeBodyClass:"mb-sidenav-visible"};e.$inject=["$mbComponentRegistry"],this.$get=e}function SidenavDirective(){return{restrict:"EA",scope:{},controller:"MbSidenavController",controllerAs:"mbSidenavCtrl"}}MbSidenavController.$inject=["$scope","$element","$attrs","$transclude","$animate","Helpers","MbComponent","$mbComponentRegistry","$mbBackdrop","$mbSidenav","$window"],angular.module("mobie.components.sidenav",["mobie.components.animation","mobie.components.backdrop","mobie.core.registry","mobie.core.component","mobie.core.helpers"]).directive("mbClose",CloseDirective).controller("MbSidenavController",MbSidenavController).provider("$mbSidenav",$MbSidenavProvider).directive("mbSidenav",SidenavDirective);
