...
function MbSimpleComponentFactory(e,t){function n(e,n,i){t.call(this),this.isVisible=!1,angular.isObject(n)&&(i=n,n=void 0,angular.extend(this,i)),angular.isDefined(e)&&this.setElement(e),angular.isDefined(n)&&this.setId(n),this.on("visibleStateChangeSuccess",function(){this.emit(this.getVisibleState()?"visible":"notVisible")}),this.on("visibleStateChangeStart",function(e){this.emit(e?"visibleChangeStart":"notVisibleChangeStart")})}return inherits(n,t,{show:function(){return this.setVisibleState(!0)},hide:function(){return this.setVisibleState(!1)},toggle:function(){return this.setVisibleState(!this.getVisibleState())},getHiddenClass:function(){return"mb-hidden"},getVisibleClass:function(){return"mb-visible"},getVisibleState:function(){return!!this.isVisible},setVisibleState:function(t){var n,i,s=this,o=this.getElement(),r=this.getHiddenClass(),a=this.getVisibleClass();return this.emit("visibleStateChangeStart",t),n=t?a:r,i=t?r:a,e.setClass(o,n,i).then(function(){s.isVisible=t,s.emit("visibleStateChangeSuccess")},function(e){s.emit("visibleStateChangeError",e)})},setId:function(e){if(angular.isDefined(this.getId()))throw new Error("You cannot change a component.id more than once");return Object.defineProperty(this,"id",{value:e,writable:!1}),this},getId:function(){return this.id},setElement:function(e){if(!e)throw new Error("invalid element");var t=this.element=angular.element(e),n=this.getVisibleState(),i=this.getHiddenClass();return t.hasClass(i)||n||t.addClass(i),this},getElement:function(){return this.element}}),n}function $MbComponentProvider(){function e(e,n,i,s,o,r){function a(n,i,s){var o=this;e.call(this),angular.isObject(n)&&(s=n,n=null),angular.isUndefined(s)&&(s={}),angular.isString(n)&&(s.template=n,n=void 0),this.options=s=angular.defaults(s,t),i&&this.setId(i),this.on("scope",function(e){var t=this.options;t.controller&&this.appendController(t.controller,t.controllerAs)}),angular.isUndefined(s.scope)&&(s.scope=r.$new());var a=s.scope=this.scope=s.scope.$new();this.emit("scope",this.scope),a.$on("$destroy",function(){o.destroy(),el=void 0}),this.on("visibleStateChangeSuccess",function(){this.digest()}),this.prepareComponent()}var l=angular.element(document.body);return inherits(a,e,{prepareComponent:function(){var e=this.scope,t=this.options;angular.isUndefined(t.template)&&angular.isDefined(t.templateUrl)&&(this.options.template=s.get(t.templateUrl));var n=t.el=angular.element(t.template),o=this.componentLink=i(n);this.once("visibleChangeStart",function(){o(e)}),this.setElement(n),this.enterElement()},locals:function(e){this.digest(function(t){angular.extend(t,e)})},appendController:function(e,t){var i=this.scope,s=this.options;return this.controller=n(s.controller,{$scope:i,$component:this}),angular.isString(t)&&($scope[t]=this.controller),this},digest:function(e){var t=this.scope;return e||(e=angular.noop),t&&t.$root?(t.$$phase||t.$root.$$phase?e&&t.$applyAsync(e):t.$apply(e),this):(e(t),this)},enterElement:function(){var e=this;return angular.isUndefined(this.parentElement)&&(this.parentElement=l),this.emit("enterElementStart"),o.enter(this.getElement(),this.parentElement).then(function(){e.emit("enter")})},removeElement:function(){return this.getElement().remove(),this.element=void 0,this},leaveElement:function(){var e=this;return this.emit("leaveElementStart"),o.leave(this.getElement()).then(function(){return e.emit("leave"),e})},destroy:function(){var e=this;return this.hide().then(function(){return e.leaveElement()}).then(function(){return e.removeAllListeners()}).then(function(){return e.removeElement()})}}),a}var t=this.defaults={};e.$inject=["MbSimpleComponent","$controller","$compile","$templateCache","$animate","$rootScope"],this.$get=e}MbSimpleComponentFactory.$inject=["$animate","EventEmitter"],angular.module("mobie.core.component",["mobie.core.helpers","mobie.components.animation"]).factory("MbSimpleComponent",MbSimpleComponentFactory).provider("MbComponent",$MbComponentProvider);
function tryFunctionObject(t){try{return fnToStr.call(t),!0}catch(r){return!1}}function isCallable(t){if("function"!=typeof t)return!1;if(hasToStringTag)return tryFunctionObject(t);var r=to_string.call(t);return r===fnClass||r===genClass}var Empty=function(){},array_push=Array.prototype.push,max=Math.max,array_slice=Array.prototype.slice,fnClass="[object Function]",to_string=Object.prototype.toString,array_concat=Array.prototype.concat,hasToStringTag="function"==typeof Symbol&&"symbol"==typeof Symbol.toStringTag;angular.extend(Function.prototype,{bind:function(t){var r=this;if(!isCallable(r))throw new TypeError("Function.prototype.bind called on incompatible "+r);for(var n,a=array_slice.call(arguments,1),o=function(){if(this instanceof n){var o=r.apply(this,array_concat.call(a,array_slice.call(arguments)));return $Object(o)===o?o:this}return r.apply(t,array_concat.call(a,array_slice.call(arguments)))},e=max(0,r.length-a.length),c=[],i=0;e>i;i++)array_push.call(c,"$"+i);return n=Function("binder","return function ("+c.join(",")+"){ return binder.apply(this, arguments); }")(o),r.prototype&&(Empty.prototype=r.prototype,n.prototype=new Empty,Empty.prototype=null),n}});
