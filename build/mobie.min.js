...
function $MbActionSheetProvider(){function n(n,e,o,c,u,i,r,a){function s(n){27==n.which&&A.close()}function f(){return m().then(function(){return C.hide()})}function l(){return m().then(function(){return C.hide()})}function h(n){o.safeDigest(A,n)}function m(){return i(function(n){h(function(t){n(t)})})}function p(){return m().then(function(){T.off("click",f),a.off("keyup",s)})}function d(){return m().then(function(){T.on("click",f),a.on("keyup",s)})}function b(n){return m().then(function(){return u[n?"addClass":"removeClass"](bodyEl,w.activeBodyClass)})}function $(n){return m().then(function(){return r(function(){return c[n?"show":"hide"]()},240)})}function g(){return S.getVisibleState()}function v(n){return m().then(function(){return S[n?"show":"hide"]()})}function k(n){return i.all([v(!1),$(n),b(!1)]).then(function(){return p()})}function x(){y({text:"",title:"",template:"",buttons:[]})}function y(n){h(function(t){angular.extend(t,n)})}function B(n){return g()?k(!0).then(function(){return B(n)}):(x(),y(n),angular.forEach(A.buttons,function(n,t){if(angular.isFunction(n.onTap)||(n.onTap=l),angular.isArray(n.classes)){var e=n.classes;n.classes={},angular.forEach(e,function(t){n.classes[t]=!0})}}),i.all([v(!0),$(!0),b(!0)]).then(function(){return d()}))}var C={},w={scope:e.$new()};w=angular.extend({},t,w);var E=C.component=n(w),S=E.component,T=(S.getElement(),c.getElement()),A=w.scope;return C.show=B,C.hide=k,A.$$close=A.close=function(){return C.hide()},A.cancelTextButton=t.cancelTextButton,A.scope=A,C}var t=this.defaults={templateUrl:"mobie/components/action-sheet.html",activeBodyClass:"mb-action-sheet-visible",cancelTextButton:"Cancel"};this.$get=n,n.$inject=["$mbComponent","$rootScope","Helpers","$mbBackdrop","$animate","$q","$timeout","$document"]}angular.module("mobie.components.action-sheet",["mobie.components.backdrop","mobie.core.component","mobie.core.helpers"]).provider("$mbActionSheet",$MbActionSheetProvider);
