...
function MbSimpleComponentFactory(t,e){function n(t,n,i){e.call(this),this.isVisible=!1,angular.isObject(n)&&(i=n,n=void 0,angular.extend(this,i)),angular.isDefined(t)&&this.setElement(t),angular.isDefined(n)&&this.setId(n),this.on("visibleStateChangeSuccess",function(){this.emit(this.getVisibleState()?"visible":"notVisible")}),this.on("visibleStateChangeStart",function(t){this.emit(t?"visibleChangeStart":"notVisibleChangeStart")})}return inherits(n,e,{show:function(){return this.setVisibleState(!0)},hide:function(){return this.setVisibleState(!1)},toggle:function(){return this.setVisibleState(!this.getVisibleState())},getHiddenClass:function(){return"mb-hidden"},getVisibleClass:function(){return"mb-visible"},getVisibleState:function(){return!!this.isVisible},getClassReceiverElement:function(){return this.classReceiverElement?this.classReceiverElement:this.getElement()},setClassReceiverElement:function(t){return this.classReceiverElement=t,this},removeElement:function(){return this.getElement().remove(),this},setVisibleState:function(e){var n,i,s=this,r=this.getClassReceiverElement(),o=this.getHiddenClass(),l=this.getVisibleClass();if(!r)throw new Error("element does not exists");return this.emit("visibleStateChangeStart",e),n=e?l:o,i=e?o:l,t.setClass(r,n,i).then(function(){s.isVisible=e,s.emit("visibleStateChangeSuccess")},function(t){s.emit("visibleStateChangeError",t)})},setId:function(t){if(angular.isDefined(this.getId()))throw new Error("You cannot change a component.id more than once");return Object.defineProperty(this,"id",{value:t,writable:!1}),this},getId:function(){return this.id},setElement:function(t){if(!t)throw new Error("invalid element");this.element=angular.element(t);var e=this.getVisibleState(),n=this.getHiddenClass(),i=this.getClassReceiverElement();return i.hasClass(n)||e||i.addClass(n),this},getElement:function(){return this.element}}),n}function $MbComponentProvider(){function t(t,n,i,s,r,o,l,a){function h(n,i,s){var o=this;t.call(this),angular.isObject(n)&&(s=n,n=null),angular.isUndefined(s)&&(s={}),angular.isString(n)&&(s.templateUrl=n,n=void 0),this.allowDigests=!1,this.options=s=mobie.defaults(s,e),!i&&s.id&&(i=s.id),i&&this.setId(i),this.on("scope",function(t){var e=this.options;e.controller&&this.appendController(e.controller,e.controllerAs)}),mobie.isScope(s.scope)||(s.scope=a.$new());var l=s.scope=this.scope=s.scope.$new();this.emit("scope",this.scope),l.$on("$destroy",function(){o.destroy()}),this.on("componentLink",function(t){this.once("visibleChangeStart",function(){t(this.scope)})}),this.on("element",function(t){this.componentLink=r(this.getElement());this.emit("componentLink",this.componentLink),this.enterElement()}),this.once("ready",function(){angular.forEach(this._digests,function(t){this.digest.apply(this,t)}.bind(this))}),(this.options.templateUrl||this.options.template)&&this.digest(function(){this.prepareComponent()})}var c=angular.element(document.body);return inherits(h,t,{storeTemplateAfterRequest:function(t){var e=this.options.templateUrl,n=t.data;return o.put(e,n),this.getTemplateSync()},getTemplateSync:function(){return this.options.template||o.get(this.options.templateUrl)},getElementAsync:function(){if(this.getElement())return i.when(this.getElement());var t=this.getTemplateSync()||n.get(this.options.templateUrl).then(this.storeTemplateAfterRequest.bind(this));return i.when(t).then(function(t){var e=angular.element(t);return this.setElement(e),this.emit("ready"),e}.bind(this))},prepareComponent:function(){return this.getElementAsync()},locals:function(t){return this.digest(function(e){angular.extend(e,t)}),this},appendController:function(t,e){var n=this.scope,i=this.options;return this.controller=s(i.controller,{$scope:n,$component:this}),angular.isString(e)&&($scope[e]=this.controller),this},_digests:[],digest:function(t,e){var n=this.scope,i=t.bind(e||this);return this.allowDigests?(i||(i=angular.noop),n&&n.$root?(n.$$phase||n.$root.$$phase?i&&n.$applyAsync(i):n.$apply(i),this):(i(n),this)):this._digests.push(arguments)},setElement:function(){if(this.getElement())throw new Error("Element already exists");var e=t.prototype.setElement;return e.apply(this,arguments),this.emit("element",this.getElement()),this},enterElement:function(){var t=this,e=this.getElement();return e?(angular.isUndefined(this.parentElement)&&(this.parentElement=c),this.emit("enterElementStart"),l.enter(e,this.parentElement).then(function(){t.emit("enter")})):i.reject(new Error("element does not exists"))},removeElement:function(){return this.getElement().remove(),this.element=void 0,this},leaveElement:function(){var t=this,e=this.getElement();return e?(this.emit("leaveElementStart"),l.leave(e).then(function(){return t.emit("leave"),t})):i.reject(new Error("element does not exists"))},postDigest:function(t){return this.scope.$$postDigest(t.bind(this)),this},destroy:function(){var t=this;return this.emit("destroy"),this.setVisibleState(!1).then(function(){return t.postDigest(t.leaveElement)}).then(function(){return t.postDigest(t.removeElement)}).then(function(){t.emit("destroyed")}).then(function(){return t.postDigest(t.removeAllListeners)})},setVisibleState:function(){var e=arguments,n=t.prototype.setVisibleState;return this.getElementAsync().then(function(){return n.apply(this,e)}.bind(this))}}),h}var e=this.defaults={};t.$inject=["MbSimpleComponent","$http","$q","$controller","$compile","$templateCache","$animate","$rootScope"],this.$get=t}MbSimpleComponentFactory.$inject=["$animate","EventEmitter"],angular.module("mobie.core.component",["mobie.core.helpers","mobie.components.animation"]).factory("MbSimpleComponent",MbSimpleComponentFactory).provider("MbComponent",$MbComponentProvider);
