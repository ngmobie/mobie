...
function BackdropFactory(e){return new e("default-backdrop")}BackdropFactory.$inject=["MbBackdrop"],angular.module("mobie.components.backdrop",["mobie.core.component"]).factory("MbBackdrop",["MbSimpleComponent","$q","$animate",function(e,t,n){function r(t){e.call(this),this.queue=[],this._queuePromise=null,this.setId(t,nextId()),this.setElement(this.createBackdropElement()),this.enterElement()}return inherits(r,e,{createBackdropElement:function(){return this.getElement()?this.getElement():angular.element(this.template)},template:'<div class="backdrop mb-backdrop"></div>',containerElement:angular.element(document.body),enterElement:function(){if(angular.isUndefined(this.getElement()))throw new Error("element does not exists");return n.enter(this.getElement(),this.containerElement)}}),r}]).factory("$mbBackdrop",BackdropFactory);
...
angular.module("mobie.components.icon",[]).directive("mbIcon",function(){return{restrict:"EA",scope:{name:"@"},template:'<span ng-class="classes" ng-show="hasIconName"></span>',controller:["$scope","$attrs",function(s,e){s.classes={fa:!0},e.$observe("name",function(e){e?s.hasIconName=s.classes["fa-"+e]=!0:s.hasIconName=!1})}]}});
function $MbModalProvider(){function e(e,t,n,i){function s(t){angular.isUndefined(t)&&(t={});var t=mobie.defaults(t,o);e.call(this,t);var n=this;this.scope;this.scope.$hide=function(){n.postDigest(function(){return n.hide()})},this.on("visibleChangeStart",this.appendBodyClass),this.on("notVisible",this.removeBodyClass)}var a=angular.element(document.body);return inherits(s,e,{appendBodyClass:function(e){return this.digest(function(){t[e?"removeClass":"addClass"](a,this.options.activeBodyClass)}),this},removeBodyClass:function(){return this.appendBodyClass(!0)}}),angular.extend(function(e){return new s(e)},{MbModal:s})}var o=this.defaults={templateUrl:"components/modal/modal.html",activeBodyClass:"mb-modal-visible"};e.$inject=["MbComponent","$animate","$mbBackdrop","$timeout"],this.$get=e}angular.module("mobie.components.modal",["mobie.core.component","mobie.core.helpers","mobie.components.backdrop"]).provider("$mbModal",$MbModalProvider);
function $MbPopupProvider(){function t(t,i){function e(){t.call(this),this.component.on("element",function(t){var n=t[0],i=function(t){t.target==n&&this.digest(function(){this.hide()})}.bind(this);this.on("bindEvents",function(){n.addEventListener("click",i)}).on("unbindEvents",function(){n.removeEventListener("click",i)})}.bind(this))}return inherits(e,t,{defaults:n}),new e}this.$get=t;var n=this.defaults={templateUrl:"mobie/components/popup.html",activeBodyClass:"mb-popup-visible"};t.$inject=["MbPopup","$mbBackdrop"]}var bodyEl=angular.element(document.body);angular.module("mobie.components.popup",["mobie.core.helpers","mobie.core.component","mobie.components.backdrop"]).factory("MbPopup",["$rootScope","MbComponent","$q","$animate",function(t,n,i,e){function s(t){EventEmitter.call(this),this.on("scope",function(t){t.close=function(){this.scope.$$postDigest(function(){this.hide()}.bind(this))}.bind(this)}),this.options={},angular.isObject(t)&&angular.extend(this.options,t),this.applyDefaults(),this.history={},this.component=new n(this.options);var i=this.options.scope=this.scope=this.component.scope;this.emit("scope",i),this.component.on("element",function(t){this.el=t,this.node=this.el[0]}.bind(this)),this.bodyElement=angular.element(document.body),Object.defineProperty(this,"lastId",{get:function(){var t=Object.keys(this.history);return t.length<1?0:parseInt(t[t.length-1])}}),angular.forEach(this.replicateEvents,function(t){this.component.on(t,function(){this.emit(t)}.bind(this))}.bind(this)),this.on("hide",function(t,n){this.history[n]=t})}return inherits(s,EventEmitter,{replicateEvents:["visible","notVisible","visibleChangeStart","notVisibleChangeStart"],getOptions:function(){return this.options},createScope:function(){return this.options.scope=this.scope=t.$new(),this.scope},applyDefaults:function(){return mobie.defaults(this.options,this.defaults),this},digest:function(t){return mobie.digest(this.scope,t,this)},asyncDigest:function(){return i(function(t){this.digest(function(n){t(n)})}.bind(this))},unbindEvents:function(){return this.asyncDigest().then(function(){this.emit("unbindEvents")}.bind(this))},bindEvents:function(){return this.asyncDigest().then(function(){this.emit("bindEvents")}.bind(this))},setActiveBodyClass:function(t){return this.asyncDigest().then(function(){return e[t?"addClass":"removeClass"](this.bodyElement,this.options.activeBodyClass)}.bind(this))},setBackdrop:function(t){return this.asyncDigest().then(function(){return $mbBackdrop[t?"show":"hide"]()})},getVisibleState:function(){return this.component.getVisibleState()},setComponent:function(t){return this.asyncDigest().then(function(){return this.component[t?"show":"hide"]()}.bind(this))},hide:function(){return this.setComponent(!1).then(function(){return this.unbindEvents()}.bind(this)).then(function(){this.emit("hide",this.options,this.id)}.bind(this))},defaultScopeAttrs:{text:"",title:"",template:"",buttons:[{text:"OK",classes:["button-stable"]}],backdropEvents:!0},reset:function(){this.locals(this.defaultScopeAttrs),this.emit("reset")},locals:function(t){return this.component.locals(t),this.emit("updated"),this},showById:function(t){var n=this.history[t];return angular.isUndefined(n)?i.reject(new Error("popup id does not exists")):this.show(n,t)},show:function(t,n){return this.getVisibleState()?this.hide().then(function(){return this.show(t,n)}.bind(this)):angular.isNumber(t)?this.showById(t):t?(this.id=n||nextId(),this.options=t,this.emit("show",t,this.id),this.reset(),this.locals(t),this.digest(function(){this.configureScope(this.scope)}),this.setComponent(!0).then(function(){return this.bindEvents()}.bind(this))):this.show(this.lastId)},configureOnTapEvent:function(t){var n=function(n){return this.emit("onTap",this.id,this.scope,n),t.call(this,this.scope,n)};return n.bind(this)},configureButtonClasses:function(t){var n=t.classes;t.classes={},angular.forEach(n,function(n){t.classes[n]=!0})},configureButtons:function(t){angular.forEach(t,function(t,n){angular.isFunction(t.onTap)||(t.onTap=this.defaultOnTapFn),angular.isArray(t.classes)&&this.configureButtonClasses(t);t.onTap;t.onTap=this.configureOnTapEvent(t.onTap)}.bind(this))},configureScope:function(t){this.configureButtons(t.buttons)},defaultOnTapFn:function(){return this.asyncDigest().then(function(){return this.hide()}.bind(this))}}),s}]).provider("$mbPopup",$MbPopupProvider);
...
function inherits(e,r,t){e.super_=r,e.prototype=Object.create(r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&angular.extend(e.prototype,t)}function nextId(){return id++,id}function digest(e,r,t){e&&(angular.isUndefined(r)&&(r=function(){}),e.$$phase||e.$root&&e.$root.$$phase?e.$applyAsync(r.bind(t)):e.$apply(r.bind(t)))}var mobie={};mobie.isScope=function(e){return e&&e.$apply&&e.$applyAsync},mobie.defaults=function(e,r){var t=angular.copy(r);return angular.isObject(e)&&angular.isObject(t)?angular.extend(e,t):e},mobie.toArray=function(e){return Array.prototype.slice.call(e)};var id=0;mobie.digest=digest,angular.module("mobie.core.helpers",["mobie.core.eventemitter"]);
