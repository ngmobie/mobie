...
function MbSimpleComponentFactory($animate, EventEmitter) {
    ...
    return inherits(MbSimpleComponent, EventEmitter, {
        ...
        setVisibleState: function(visibleState) {
            ...
            if (!classReceiverElement) throw new Error("element does not exists");
...
function $MbComponentProvider() {
    function $MbComponentFactory(MbSimpleComponent, $http, $q, $controller, $compile, $templateCache, $animate, $rootScope) {
        function MbComponent(componentEl, id, options) {
            ...
            componentEl = void 0), this.allowDigests = !1, this.options = options = mobie.defaults(options, defaults), 
        ...
        return inherits(MbComponent, MbSimpleComponent, {
            ...
            getElementAsync: function() {
                ...
                return $q.when(template).then(function(template) {
                    ...
                    return this.setElement(element), this.emit("ready"), element;
                }.bind(this));
            },
            ...
            digest: function(callback, context) {
                var scope = this.scope, fn = callback.bind(context || this);
                return this.allowDigests ? (fn || (fn = angular.noop), scope && scope.$root ? (scope.$$phase || scope.$root.$$phase ? fn && scope.$applyAsync(fn) : scope.$apply(fn), 
                this) : (fn(scope), this)) : this._digests.push(arguments);
            },
            setElement: function() {
            ...
            setVisibleState: function() {
                var args = arguments, setVisibleState = MbSimpleComponent.prototype.setVisibleState;
...
angular.module("mobie.components.action-sheet", [ "mobie.components.backdrop", "mobie.core.component", "mobie.core.helpers" ]).factory("MbActionSheet", [ "$mbBackdrop", "MbPopup", function($mbBackdrop, MbPopup) {
    ...
    return inherits(MbActionSheet, MbPopup, {
        ...
        configureScope: function(scope) {
            ...
            groups && groups.length < 1 && buttons && this.noGroupApproach(scope, buttons), 
...
angular.module("mobie.components.popup", [ "mobie.core.helpers", "mobie.core.component", "mobie.components.backdrop" ]).factory("MbPopup", [ "$rootScope", "MbComponent", "$q", "$animate", function($rootScope, MbComponent, $q, $animate) {
    ...
    return inherits(MbPopup, EventEmitter, {
        ...
        digest: function(fn) {
            return this.component.digest(fn, this), this;
        },
