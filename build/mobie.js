...
EventEmitter.defaultMaxListeners = 10, EventEmitter.init = function() {
    ...
    if (!utilangularisNumber(n) || 0 > n || isNaN(n)) throw TypeError("n must be a positive number");
    ...
    var m;
    if (!angular.isFunction(listener)) throw TypeError("listener must be a function");
